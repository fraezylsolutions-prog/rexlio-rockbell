            ...
            <div class="table-box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <?php /* VIP tier price (tier_key 4). Blank falls back to Sale Price. */ ?>
                                <label><?php echo lang('sale_price'); ?> (<?php echo lang('vip'); ?>)</label>
                                <input tabindex="1" type="text" id="sale_price_vip" name="sale_price_vip" class="form-control"
                                       placeholder="<?php echo lang('sale_price'); ?> (<?php echo lang('vip'); ?>)"
                                       value="<?php echo escape_output(isset($food_menu_details->sale_price_vip) ? $food_menu_details->sale_price_vip : '') ?>">
                            </div>
                        </div>
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <?php /* Club tier price (tier_key 5). Blank falls back to Sale Price. */ ?>
                                <label><?php echo lang('sale_price'); ?> (<?php echo lang('club'); ?>)</label>
                                <input tabindex="1" type="text" id="sale_price_club" name="sale_price_club" class="form-control"
                                       placeholder="<?php echo lang('sale_price'); ?> (<?php echo lang('club'); ?>)"
                                       value="<?php echo escape_output(isset($food_menu_details->sale_price_club) ? $food_menu_details->sale_price_club : '') ?>">
                            </div>
                        </div>

                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <?php /* Phase F item 17. Applies to every food menu, so it sits here
                                         with the prices rather than inside the product_type 3 block. */ ?>
                                <label><?php echo lang('oversale_policy'); ?></label>
                                <?php $ir_oversale = isset($food_menu_details->oversale_policy) ? (int) $food_menu_details->oversale_policy : 0; ?>
                                <select tabindex="1" class="form-control select2" name="oversale_policy" id="oversale_policy">
                                    <option <?= $ir_oversale === 0 ? 'selected' : '' ?> value="0"><?php echo lang('oversale_use_global'); ?></option>
                                    <option <?= $ir_oversale === 1 ? 'selected' : '' ?> value="1"><?php echo lang('oversale_always_allow'); ?></option>
                                    <option <?= $ir_oversale === 2 ? 'selected' : '' ?> value="2"><?php echo lang('oversale_always_block'); ?></option>
                                </select>
                                <small class="text-muted"><?php echo lang('oversale_policy_hint'); ?></small>
                            </div>
                        </div>
