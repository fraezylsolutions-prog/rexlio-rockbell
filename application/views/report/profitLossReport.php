                ...
                <div class="table-responsive">
                    <table class="table" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>2</td>
                                <td> <?php echo lang('profit_3'); ?> (<?php echo lang('average_purchase_price'); ?>)</td>
                                <td><?= isset($saleReportByDate['profit_3']) ? getAmtCustom($saleReportByDate['profit_3']) : getAmtCustom(0) ?>
                                </td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td> <?php echo lang('profit_4'); ?> (<?php echo lang('average_purchase_price'); ?>)</td>
...
<script src="<?php echo base_url(); ?>frequent_changing/js/no_pagi_report.js?v=1.1"></script>