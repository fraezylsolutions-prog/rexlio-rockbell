                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <?php
                                /* VIP tier price (tier_key 4). Left blank, the tier falls back to
                                   Sale Price, so an item with no VIP price simply sells at its
                                   normal price rather than at zero. */
                                ?>
                                ...
                                <input tabindex="1" type="text" id="sale_price_vip" name="sale_price_vip" class="form-control"
                                       ...
                                       value="<?php echo set_value('sale_price_vip'); ?>">
                            </div>
                        </div>
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <?php /* Club tier price (tier_key 5). Same fallback rule as VIP. */ ?>
                                ...
                                <input tabindex="1" type="text" id="sale_price_club" name="sale_price_club" class="form-control"
                                       ...
                                       value="<?php echo set_value('sale_price_club'); ?>">
                            </div>
                        </div>
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <select tabindex="1" class="form-control select2" name="oversale_policy" id="oversale_policy">
                                    <option value="0" selected><?php echo lang('oversale_use_global'); ?></option>
                                    <option value="1"><?php echo lang('oversale_always_allow'); ?></option>
                                    <option value="2"><?php echo lang('oversale_always_block'); ?></option>
                                </select>
