    ...
    <section class="content-header">
        <div class="row">
            <div class="col-sm-12 mb-3 col-md-6">
                <h3 class="top-left-header"><?php echo lang('inventory'); ?>
                    <small class="text-muted">&nbsp;|&nbsp;<?php echo escape_output(outletScopeLabel($outlet_scope)); ?></small>
                </h3>
            </div>
            ...
            <div class="table-responsive">
                ...
                <table id="datatable" class="table">
                    ...
                    <tr>
                        ...
                        <th class="title" class="ir_w_15"><?php echo lang('committed_qty'); ?>
                            <small class="text-muted d-block"><?php echo lang('committed_qty_hint'); ?></small>
                        </th>
                        <th class="title" class="ir_w_15"><?php echo lang('available_qty'); ?></th>
                        ...
                        foreach ($inventory as $key => $value):
                            ...
                            if($value->id):
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <?php
                                    //Phase F item 14. Committed is stock already promised to
                                    //placed but uncompleted orders; it is NOT deducted from the
                                    //audit ledger, only subtracted here for the live figure.
                                    $ir_committed = isset($committed[$value->id]) ? (float) $committed[$value->id] : 0.0;
                                    $ir_available = $totalStock - $ir_committed;
                                    ?>
                                    <td>
                                        <?php if ($ir_committed > 0): ?>
                                            <span class="ir_color_red"><?php echo escape_output(getAmtP($ir_committed)); ?></span>
                                            <?= " " . escape_output($value->unit_name) ?>
                                        <?php else: ?>
                                            <span class="text-muted">&mdash;</span>
                                        <?php endif; ?>
                                    </td>
                                    <td style="<?= ($ir_available <= 0) ? 'color:red;font-weight:600' : '' ?>">
                                        <?php echo escape_output(getAmtP($ir_available)); ?>
                                        <?= " " . escape_output($value->unit_name) ?>
                                    </td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2">
                            <div class="form-group">
                                <select class="form-control select2 ir_w_100" name="outlet_scope" id="outlet_scope">
