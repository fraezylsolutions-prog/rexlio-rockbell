...
<input type="hidden" id="order_not_on_this_device" value="<?php echo lang('order_not_on_this_device'); ?>">
...
<input type="hidden" id="price_tier_changing_alert" value="<?php echo lang('price_tier_changing_alert') ?>">
