<section class="main-content-wrapper">
    <section class="content-header">
        <div class="col-md-12">
            <h3 class="top-left-header text-left"><?php echo lang('Alert_Inventory'); ?>
        ...
        <div class="row">
            ...
            <?php if ($show_outlet_filter): ?>
                <?php echo form_open(base_url() . 'Inventory/getInventoryAlertList') ?>
                <div class="col-sm-12 col-md-3">
                    <div class="form-group">
                        <select class="form-control select2 ir_w_100" name="outlet_scope" onchange="this.form.submit()">
