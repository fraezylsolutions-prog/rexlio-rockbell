...
class Counter extends Cl_Controller {
    ...
    public function __construct() {
        ...
        //price tier list for the counter's Default Price Tier dropdown
    ...
    public function addEditCounter($encrypted_id = "") {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $igc_info['default_price_tier'] = (int) htmlspecialcharscustom($this->input->post($this->security->xss_clean('default_price_tier')));
                if(!$igc_info['default_price_tier']){ $igc_info['default_price_tier'] = 1; }
