...
?>
  ...
  <?php
                            ...
                            <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                                <div class="form-group">
                                    <label><?php echo lang('allow_oversale'); ?></label>
                                    <table>
                                        <tr>
                                            <td class="ir_w_100">
                                                <?php
                                                //Defaults to Yes (oversale permitted) so this setting
                                                //changes nothing until it is deliberately switched.
                                                $ir_allow_oversale = (isset($outlet_information->allow_oversale) && strcasecmp(trim($outlet_information->allow_oversale), 'No') == 0) ? 'No' : 'Yes';
                                                ?>
                                                <select tabindex="12" class="form-control select2" name="allow_oversale" id="allow_oversale">
                                                    <option <?= $ir_allow_oversale == 'Yes' ? 'selected' : '' ?> value="Yes"><?php echo lang('yes'); ?></option>
                                                    <option <?= $ir_allow_oversale == 'No' ? 'selected' : '' ?> value="No"><?php echo lang('no'); ?></option>
                                                </select>
                                            </td>
                                            <td>
                                                <div class="tooltip_custom">
                                                    <i class="fa fa-question fa-2x form_question" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('allow_oversale_tooltip'); ?>"></i>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
