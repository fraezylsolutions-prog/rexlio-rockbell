...
class Purchase extends Cl_Controller {
    ...
    public function purchases() {
        ...
        //filters posted from the purchase list screen, empty value means "all".
        //same filter set and field names as the purchase report screen
        $filters = array();
        $filters['start_date'] = htmlspecialcharscustom($this->input->post($this->security->xss_clean('startDate')));
        $filters['end_date'] = htmlspecialcharscustom($this->input->post($this->security->xss_clean('endDate')));
        ...
        $data['purchases'] = $this->Purchase_model->getFilteredPurchases($outlet_id, $filters);
