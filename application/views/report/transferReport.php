        ...
        <div class="col-md-12">
            ...
            <div class="table-box">
                ...
                <div class="box-body table-responsive">
                    <h3 class="top-left-header text-left"><?php echo lang('transferReport'); ?></h3>
                    <section class="content-header">
                        <input type="hidden" class="datatable_name" data-title="<?php echo lang('transferReport'); ?>" data-id_name="datatable">
                    ...
                    <div class="box-wrapper">
                        <div class="row mb-3">
                            <div class="col-sm-12 col-md-4 col-lg-2 mb-3">
                                <?php echo form_open(base_url() . 'Report/transferReport', $arrayName = array('id' => 'foodMenuSales')) ?>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="datatable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo lang('ingredients'); ?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
