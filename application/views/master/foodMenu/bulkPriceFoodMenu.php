 <section class="main-content-wrapper">
     ...
     if ($this->session->flashdata('exception_err')) {
        ...
        <p><i class="m-right fa fa-times"></i>';
         // not escaped: the importer builds a multi-line <br> separated error list
         echo ($this->session->flashdata('exception_err'));unset($_SESSION['exception_err']);
         echo '</p></div></div></section>';
     }
     ?>
    <section class="content-header">
        <h3 class="top-left-header"><?php echo lang('bulk_price_update'); ?></h3>
    </section>
    <div class="box-wrapper">
        <div class="table-box">
            <div class="callout callout-info">
                <p><?php echo lang('bulk_price_update_note'); ?></p>
            </div>

            <?php /* Step 1: download the current prices for one outlet. The outlet is
                     written into the file itself, so the re-upload cannot be applied to
                     a different site by mistake. */ ?>
            <h4><?php echo lang('step').' 1: '.lang('download'); ?></h4>
            <?php echo form_open(base_url('foodMenu/downloadFoodMenuPrices')); ?>
            <div class="row">
                <div class="col-md-5">
            ...
            <?php echo form_open_multipart(base_url('foodMenu/ExcelDataUpdateFoodmenuPrices')); ?>
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
