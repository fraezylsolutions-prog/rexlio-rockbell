...
<html>
    ...
    <?php /* Theme layer. Loaded LAST so it overrides the stylesheets above
         without editing them - the whole theme can be removed by deleting
         these three lines. */ ?>
    <script>
        /* Applied before first paint. Without this the browser renders the
           default theme and then repaints, so every page load flashes white
           at a cashier working in a dark room. */
                    ...
                    <div class="hh_wrapper">
                        ...
                        <div class="navbar-custom-menu">
                            <ul class="menu-list">
                                ...
                                <li class="rx-theme-li">
                                    <div class="rx-theme-toggle" role="group" aria-label="Colour theme">
                                        <button type="button" data-mode="light" aria-pressed="true"
                                                title="<?php echo lang('theme_light'); ?>"
                                                aria-label="<?php echo lang('theme_light'); ?>">&#9788;</button>
                                        <button type="button" data-mode="dark" aria-pressed="false"
                                                title="<?php echo lang('theme_dark'); ?>"
                                                aria-label="<?php echo lang('theme_dark'); ?>">&#9789;</button>
                                    </div>
                                </li>
                    ...
                    <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
                        ...
                        <li class="treeview menu__cidirp_hotel common_use" id="ir_hotel_menu">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li data-access="view-<?php echo irAccessModuleId('hotel_reports'); ?>" class="menu_assign_class" data-menu__cid="irp_hotel"><a class="child-menu" href="<?php echo base_url()?>Hotel/reports">
                                        <?php echo lang('hk_reports'); ?></a></li>
                            </ul>
                        </li>
                        <?php endif; ?>
                        <li class="treeview menu__cidirp_4 common_use">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php /* Phase C monitor screens. Previously reachable only from the POS
                                         toolbar; these give them a sidebar entry point too.
                                         data-access uses the same function-controller tokens the
                        ...
                        <li class="treeview menu__cidirp_15 setting_report1">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li data-access="view-370" class="menu_assign_class" data-menu__cid="irp_15"><a class="child-menu" href="<?php echo base_url()?>Report/stockReport"><?php echo lang('stock_report'); ?></a></li>
