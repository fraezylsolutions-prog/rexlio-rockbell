    ...
    ?>
        ...
        <div class="box-wrapper">
            <div class="d-flex justify-content-end">
                ...
                <?php /* Entry point for the Bulk Price Update tool. data-access carries
                     the permission key so the button is hidden from roles that do not
                     hold it, exactly like the two upload buttons above. Without this the
                     screen exists but is reachable only by typing the URL. */ ?>
                <a data-access="bulk_price_food_menu-234" class="new-btn menu_assign_class me-2" href="<?php echo base_url() ?>foodMenu/bulkPriceFoodMenu">
                    <i class="m-right fa fa-tags"></i> <?php echo lang('bulk_price_update'); ?>
                </a>
