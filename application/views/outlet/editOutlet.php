        ...
        <div class="table-box">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12 mb-2 col-md-3">
                        <div class="form-group">
                            <label><?php echo lang('is_sales_enabled'); ?> <span class="required_star">*</span></label>
                            <?php $ir_sales_enabled = isset($outlet_information->is_sales_enabled) ? (int) $outlet_information->is_sales_enabled : 1; ?>
                            <select class="form-control select2" name="is_sales_enabled" id="is_sales_enabled">
                                <option <?php echo $ir_sales_enabled === 1 ? 'selected' : '' ?> value="1"><?php echo lang('yes'); ?></option>
                                <option <?php echo $ir_sales_enabled === 0 ? 'selected' : '' ?> value="0"><?php echo lang('no'); ?></option>
                            </select>
                            <small class="text-muted"><?php echo lang('is_sales_enabled_hint'); ?></small>
                        </div>
                    </div>
