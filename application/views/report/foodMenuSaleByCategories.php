    ...
    <div class="my-2">
        <?php
                    if(isLMni() && isset($outlet_scope_label)):
                        ?>
                        <h4> <?php echo lang('outlet'); ?>: <?php echo escape_output($outlet_scope_label)?></h4>
                        <?php
                    endif;
                    ?>
        ...
        <div class="box-wrapper">
                <div class="row mb-3">
                        ...
                        ?>
                        <?php /* R4: seller filter. */ ?>
                        <div class="col-sm-12 col-md-4 col-lg-2 mb-3">
                            <div class="form-group">
                                <select tabindex="2" class="form-control select2 ir_w_100" name="user_id">
                        ...
                        <?php /* R4: time-of-day range, filtered on order_time. This is CLOCK
                                 time and is deliberately independent of the date range above,
                                 which filters the BUSINESS day - a late sale books to the next
                                 day, so the two can legitimately disagree by one. */ ?>
                        <div class="col-sm-12 col-md-4 col-lg-2 mb-3">
                            <div class="form-group">
